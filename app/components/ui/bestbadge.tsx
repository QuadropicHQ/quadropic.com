interface RankAnnouncementProps {
    children?: React.ReactNode;
    className?: string;
}

export default function RankAnnouncement({ children = "We're MOST accurate on SWE Bench", className }: RankAnnouncementProps) {
    return (
        <button 
            onClick={() => window.open('https://insiders.quadropic.com/insiders/syntheo-tops-swelite-feb', '_blank')}
